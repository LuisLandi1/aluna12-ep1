...
function envia() {
    ...
    var url = 'CalaculaSim.php?capital=' + capital + '&taxa=' + taxa + '&tempo=' + tempo;
    fetch(url)
	.then(response => response.json())
	.then(data => {
	    document.getElementById('mostrar').textContent = "Os juros são: R$" + data.juros.toFixed(2);
	});
}
    </script>
</head>
...
<img src="https://media.baamboozle.com/uploads/images/120763/1656273165_685451_gif-url.gif" alt="">
</body>
</html>  